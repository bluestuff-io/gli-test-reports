...
> [Custom] Base game win never exceeds 5000x cap — custom cases run against the game-engine-template contract, but this backend is not a template backend, so it was not executed here.

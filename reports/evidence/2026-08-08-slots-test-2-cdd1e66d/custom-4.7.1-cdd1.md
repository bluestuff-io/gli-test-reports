# Requirement custom:4.7.1 — 🔵 MANUAL REVIEW

> [Custom] Base-game RTP matches declared 94.0636% — custom cases run against the game-engine-template contract, but this backend is not a template backend, so it was not executed here.

## What was tested

| | |
|---|---|
| **Requirement** | GLI-19 custom:4.7.1 (GLI-19 v3.0) |
